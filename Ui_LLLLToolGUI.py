...
class Ui_L4ToolMW(object):
    def setupUi(self, L4ToolMW):
        ...
        self.basicGroup = QGroupBox(self.fridaPage)
        ...
        self.connectDeviceComboBox.setEditable(True)
        ...
        self.gridLayout_2.addWidget(self.basicGroup, 0, 0, 1, 2)

        self.closeBtn = QPushButton(self.fridaPage)
        ...
        self.attachBtn = QPushButton(self.fridaPage)
        ...
        self.gridLayout_2.addWidget(self.attachBtn, 2, 1, 1, 1)

        self.applyCfgBtn = QPushButton(self.fridaPage)
        self.applyCfgBtn.setObjectName(u"applyCfgBtn")
        sizePolicy2.setHeightForWidth(self.applyCfgBtn.sizePolicy().hasHeightForWidth())
        self.applyCfgBtn.setSizePolicy(sizePolicy2)

        self.gridLayout_2.addWidget(self.applyCfgBtn, 3, 1, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.replaceOldResCheckBox.sizePolicy().hasHeightForWidth())
        self.replaceOldResCheckBox.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.getResVersionsBtn.sizePolicy().hasHeightForWidth())
        self.getResVersionsBtn.setSizePolicy(sizePolicy1)
    ...
    def retranslateUi(self, L4ToolMW):
        ...
        self.basicGroup.setTitle(QCoreApplication.translate("L4ToolMW", u"\u57fa\u7840\u8bbe\u7f6e", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.groupBox_5.setTitle(QCoreApplication.translate("L4ToolMW", u"\u6e32\u67d3\u5206\u8fa8\u7387", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.fridaPage), QCoreApplication.translate("L4ToolMW", u"Frida", None))
